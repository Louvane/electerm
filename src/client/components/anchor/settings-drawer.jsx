    ...
    >
      <details className='dr-sec' open>
        ...
        <div className='inner'>
          ...
          <div className='fld'>
            <label>字体</label>
            <input value={cfg.fontFamily || ''} onChange={e => set('fontFamily', e.target.value)} placeholder='Maple Mono, monospace' style={{ flex: 1 }} />
          </div>
          <div className='fld'>
            <label>光标样式</label>
      ...
      <details className='dr-sec' open>
        ...
        <div className='inner'>
          <div className='fld'>
            <label>心跳间隔</label>
            <InputNumber min={5000} max={60000} step={1000} addonAfter='ms' value={cfg.keepaliveInterval || 10000} onChange={v => set('keepaliveInterval', v || 10000)} style={{ flex: 1 }} />
          </div>
          <div className='fld'>
            <label>SSH 超时</label>
            <InputNumber min={10000} max={120000} step={5000} addonAfter='ms' value={cfg.sshReadyTimeout || 50000} onChange={v => set('sshReadyTimeout', v || 50000)} style={{ flex: 1 }} />
          </div>
        </div>
      </details>
